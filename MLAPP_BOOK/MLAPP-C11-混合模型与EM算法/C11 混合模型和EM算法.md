...
<p><img src=".\pic\11.1.png"></p>
图11.1 一个包含和不包含隐藏变量的DGM。叶子节点代表医学症状。这些根节点代表了主要原因，比如吸烟、节食和锻炼。隐藏变量可以表示中间因素，如心脏病，这可能不是直接可见的.
...
<p><img src=".\pic\11.3_a.png"></p>
<p><img src=".\pic\11.3_b.png"></p>
...
<p><img src=".\pic\11.4_a.png"></p>


<p><img src=".\pic\11.4_b.png"></p>
...
上式中$ p(x\_{it},\mathbf{x}\_{i,pa(t)}|\mathcal{D}\_i,\mathbf{\theta}) $为**族边缘(family marginal)**，可以使用GM推理算法获得。$\bar{N}\_{tjk}$为期望充分统计量，也就是E步骤的输出。
